from app.application.dtos.complex_data import UpdateComplexElementDto
from app.extensions import db
from app.infrastructure.db.models.complex_data import ComplexElementModel

class UpdateComplexElementUseCase:
    def __init__(self) -> None:
        self._session = db.session

    def execute(self, dto: UpdateComplexElementDto) -> None:
        element = (
            self._session
